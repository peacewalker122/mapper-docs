...
See [Install the frontend SDK](/mapper-docs/installation/frontend/) for the
npm/pnpm/yarn/bun commands and stylesheet import.
...
For local SDK development (inside the `mapper-fe` repo):
